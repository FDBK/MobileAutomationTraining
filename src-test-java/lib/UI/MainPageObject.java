...
public class MainPageObject
{
    ...
    public void scrollWebPageWhileElementIsNotVisible(String locator, String error_message, int max_swipes)
    {
    ...
    public void swipeUpToFindElement(String locator, String error_message, int max_swipes)
    {
        ...
        while (driver.findElements(by).size() == 0) {
            ...
            if (already_swiped > max_swipes) {
                waitForElementPresent(locator, "Error! Cannot find element by swiping up. \n" + error_message, 0);
                return;
            }
    ...
    public void assertElementNotPresent(String locator, String error_message)
    {
        ...
        if (amount_of_elements > 0) {
            String default_message = "An element " + locator + " is supposedly not present.";
    ...
    public String takeScreenshot(String name)
    {
        ...
        try {
            ...
            System.out.println("Error! Unable to take the screenshot: " + e.getMessage() + ".");
        }
        return path;
    }
    ...
    public static byte[] screenshot(String path)
    {
        ...
        try {
            ...
            System.out.println("Error! Unable to get bytes from the screenshot: " + e.getMessage());
        }
        return bytes;
    }
